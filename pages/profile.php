...
<header>
    ...
    <div id="baner" class="bio">
        <h1 class="title_bio">JULIAN WILD</h1>
    </div>
</header>
<main>
    ...
    <div class="responsive">
        ...
        <p class="p1">
            Hey, like you can see I’m not the typical type of guy you see with a camera!
        ...
        <p class="p2">
            love to travel and discover new places, meet new people, habitat and cities. That was my dream when I
        ...
        <p>
            Special thanks to Lola, Emily, Sten, Aurelien, Aristide Taegyung and Loukman !
        </p>
    </div>
</main>
